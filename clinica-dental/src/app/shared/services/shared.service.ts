...
export class SharedService {
  getData() {
    return [
      {
        itemImageSrc: 'https://www.dvd-dental.com/blogodontomecum/wp-content/uploads/2019/12/distribuci%C3%B3n-clinica-dental.jpg',
        thumbnailImageSrc: 'https://www.dvd-dental.com/blogodontomecum/wp-content/uploads/2019/12/distribuci%C3%B3n-clinica-dental.jpg',
  ...
  getProductsSmall() {
    return Promise.resolve(this.getProductsData().slice(0, 12));
  }
